...
The completed MVP implementation line is `0.1.7.0`. Follow-up acceptance fixes increment PATCH: persisted frame opacity shipped in `0.1.7.1`, the bounded hybrid diagnostic snapshot shipped in `0.1.7.2`, and neutral encounter-target fallback support shipped in `0.1.7.3`.
