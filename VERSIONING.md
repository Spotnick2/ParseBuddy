...
The completed MVP implementation line is `0.1.7.0`. Follow-up acceptance fixes increment PATCH until a new release line or expanded scope warrants a MINOR/BUILD change.
