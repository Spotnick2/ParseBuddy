...
-- One click, one atomic transition across both stored booleans.
assertEqual(Model:SetGroupMode("majorArmor", "bogus"), false, "unknown group mode rejected")
assertEqual(Model:SetGroupMode("majorArmor", "applied"), true, "applied mode interaction accepted")
assertEqual(ParseBuddyDB.settings.groups.majorArmor.enabled, true, "applied mode keeps tracking on")
assertEqual(ParseBuddyDB.settings.groups.majorArmor.visibility, "applied", "applied mode writes visibility")
assertEqual(ParseBuddyDB.settings.groups.majorArmor.required, false, "applied mode leaves the alert flag as it was")
Model:SetGroupValue("majorArmor", "required", true)
Model:SetGroupMode("majorArmor", "applied")
assertEqual(ParseBuddyDB.settings.groups.majorArmor.required, true, "applied mode preserves a set alert flag")
Model:SetGroupMode("majorArmor", "always")
assertEqual(ParseBuddyDB.settings.groups.majorArmor.required, true, "returning to always restores the alert flag")
Model:SetGroupValue("majorArmor", "required", false)
Model:SetGroupMode("majorArmor", "applied")
assertEqual(Model:GetState().groups.majorArmor.mode, "applied", "panel reports the applied tier")
assertEqual(Model:GetState().groups.majorArmor.requiredEnabled, false, "alert checkbox disabled for applied-only")
assertEqual(Model:SetGroupMode("majorArmor", "off"), true, "off mode interaction accepted")
assertEqual(ParseBuddyDB.settings.groups.majorArmor.enabled, false, "off mode stops tracking")
assertEqual(ParseBuddyDB.settings.groups.majorArmor.visibility, "applied", "off mode preserves the chosen tier")
assertEqual(Model:GetState().groups.majorArmor.mode, "off", "panel reports the off tier")
assertEqual(Model:SetGroupMode("majorArmor", "always"), true, "always mode interaction accepted")
assertEqual(ParseBuddyDB.settings.groups.majorArmor.enabled, true, "always mode resumes tracking")
assertEqual(ParseBuddyDB.settings.groups.majorArmor.visibility, "always", "always mode writes visibility")
assertEqual(Model:GetState().groups.majorArmor.requiredEnabled, true, "alert checkbox enabled for always-shown")
Model:SetGroupValue("majorArmor", "required", false)
